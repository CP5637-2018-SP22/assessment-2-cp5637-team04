...
if ( ! function_exists( 'u3a_setup' ) ) :
	...
	function u3a_setup() {
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'u3a' ),
                    'social' => esc_html__( 'social media menu', 'u3a' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'u3a_custom_background_args', array(
...
function u3a_scripts() {
	wp_enqueue_style( 'u3a-style', get_stylesheet_uri() );

	wp_enqueue_script( 'u3a-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'u3a-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
